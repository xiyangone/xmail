...
- 🔗 **分享功能**：支持生成邮箱和单个邮件的分享链接，可设置有效期（1小时/24小时/3天/永久），支持桌面端双栏布局和移动端单栏布局，完整的错误处理和过期状态显示
...
- **5000ms (5 秒)**: 快速刷新，适合需要实时接收邮件的场景
- **15000ms (15 秒)**: 平衡选择，默认值
- **30000ms (30 秒)**: 降低服务器负载
...
XiYang Mail 支持生成邮箱和单个邮件的分享链接，方便与他人分享邮件内容。

### 功能特性

- 📧 **邮箱分享**：分享整个邮箱，他人可查看该邮箱的所有邮件
- 💌 **单邮件分享**：分享单个邮件，他人只能查看该邮件内容
...
- **邮件分享链接**：`https://your-domain.com/shared/message/{token}`
